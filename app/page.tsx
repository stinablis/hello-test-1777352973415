...
export default function Home() {
  ...
  const products = [{ n: 'test', d: 'Our Test Product 1 is a cutting-edge solution designed to streamline processes and increase efficiency, featuring advanced technology and user-friendly interface. With its robust features and flexible customization options, it is an ideal choice for businesses looking to enhance their operations.', i: 'https://images.pexels.com/photos/9227854/pexels-photo-9227854.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'domain' }, { n: 'test', d: 'Test Product 2 is a comprehensive suite of tools and services designed to help businesses grow and thrive, offering a range of benefits including increased productivity, improved customer engagement, and enhanced competitiveness. Its scalable architecture and seamless integration capabilities make it an attractive option for companies of all sizes.', i: 'https://images.pexels.com/photos/7723197/pexels-photo-7723197.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'architecture' }, { n: 'test', d: 'Test Product 3 is a innovative product that combines advanced technology with intuitive design, providing users with a unique and engaging experience. With its sleek interface and robust features, it is perfect for individuals and businesses looking to stay ahead of the curve.', i: 'https://images.pexels.com/photos/6576813/pexels-photo-6576813.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'chair' }, { n: 'test', d: 'Our Test Product 4 is a specialized solution designed to address specific industry challenges, featuring a range of advanced features and capabilities. Its customizable nature and user-friendly interface make it an ideal choice for companies seeking to enhance their operations and improve their bottom line.', i: 'https://images.pexels.com/photos/10878607/pexels-photo-10878607.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'eco' }, { n: 'test', d: 'Test Product 5 is a revolutionary product that is poised to disrupt the status quo, offering a fresh perspective and a new way of thinking. With its groundbreaking technology and innovative design, it is set to change the way businesses operate and interact with their customers.', i: 'https://images.pexels.com/photos/5342564/pexels-photo-5342564.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'precision_manufacturing' }];
    ...
    <div className="min-h-screen bg-surface text-on-surface font-body selection:bg-accent/30 selection:text-primary">
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="https://images.pexels.com/photos/9227854/pexels-photo-9227854.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" alt="Hero" className="w-full h-full object-cover" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <p className="text-on-surface-variant text-lg leading-relaxed">
                At Hello Test, we are dedicated to providing innovative solutions to meet the evolving needs of our customers. With a strong commitment to quality and excellence, we strive to deliver exceptional products and services that exceed expectations. Our goal is to build long-lasting relationships with our clients and establish ourselves as a trusted leader in our industry.
              </p>
              {/* 4 Pillars Grid */}
              <div className="grid grid-cols-2 gap-8 pt-8">
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Vision</h4>
                  <p className="text-sm text-on-surface-variant">Our vision is to revolutionize the way people interact with our products and services, creating a seamless and intuitive experience that sets a new standard for excellence.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">Mission</h4>
                  <p className="text-sm text-on-surface-variant">Our mission is to design, develop, and deliver high-quality products and services that meet the unique needs of our customers, while fostering a culture of innovation, integrity, and customer satisfaction.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">tets</h4>
                  <p className="text-sm text-on-surface-variant">At Hello Test, our first core value is a relentless pursuit of excellence, where we continuously strive to improve our products, services, and processes to deliver exceptional results.</p>
                </div>
                <div className="space-y-2">
                  <h4 className="font-headline font-bold text-primary">test</h4>
                  <p className="text-sm text-on-surface-variant">Our second core value is a deep commitment to customer satisfaction, where we listen to our customers, understand their needs, and tailor our solutions to exceed their expectations.</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              <div className="col-span-8 row-span-4 overflow-hidden rounded-xl">
                <img src="https://images.pexels.com/photos/11624146/pexels-photo-11624146.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 1" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-4 row-span-3 overflow-hidden rounded-xl bg-surface-container">
                <img src="https://images.pexels.com/photos/7681119/pexels-photo-7681119.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 2" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://images.pexels.com/photos/9243744/pexels-photo-9243744.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
